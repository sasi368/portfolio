...
const projectsDetails = [
  ...
  {
    title: "Fantasy Sports - Dream11 Clone App",
    description:
      "The Dream11 clone app is a feature-rich fantasy sports platform that allows users to create their own virtual teams, join contests, and win real rewards. With real-time match updates, secure payment integration, and an intuitive user interface, the app delivers an engaging experience for sports enthusiasts. Users can participate in multiple leagues, track their performance, and enjoy seamless gameplay with advanced analytics and leaderboards.",
    playstore: "",
    appstore: "",
    site: "",
    techUses: [
...
export { links, contents, projectsDetails };
